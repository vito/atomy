...
# STANDALONE START
  ...
  # word = line:line identifier:n !{ no_op && operator?(n) } { Atomy::AST::Word.new(line, n) }
  def _word(no_op)
  ...
  def _prefix
    ...
    while true # sequence
      ...
      @result = begin;  Atomy::AST::Prefix.new(line, e, o) ; end
      _tmp = true
      unless _tmp
        self.pos = _save
      end
  ...
  # binary_op = (operator | identifier:n &{ operator?(n) } { n })
  def _binary_op
